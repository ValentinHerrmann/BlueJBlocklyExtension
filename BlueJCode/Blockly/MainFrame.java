...
class MainFrame extends JFrame
{
    ...
    private Component browserUI_ = null;
    ...
    MainFrame(String startURL, boolean useOSR, boolean isTransparent, String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        Logging.log(">>> MainFrame.MainFrame");
        try
        {
        ...
        {
            Logging.log("MainFrame: " + e.toString());
            Logging.log(e.getStackTrace());
        }
        Logging.log("<<< MainFrame.MainFrame");
    }

    // Override dispose methode which
    ...
    void realDispose()
    {
        Logging.log(">>> MainFrame.realDispose");
        try
        {
            super.dispose();
            Logging.log("MainFrame disposed");
            CefApp.getInstance().dispose();
            Logging.log("CEF disposed");
        }
        catch (Exception e)
        {
            Logging.log("MainFrame: " + e.toString());
    ...
    // Reload browser and force Blockly
    // to request current java class and xml
    void reload()
    {
        Logging.log(">>> MainFrame.reload");
        try
        {
            browser_.reload();
        }
    ...
    public static void main(String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        Logging.log(">>> MainFrame.main");
        try
        {
            boolean useOsr = false;
            String url = args.length > 0 ? args[0] : "www.google.com";
